...
data_cache = './data/cache/data_cache_size10.00_split655200_x0.20y0.10.pkl'
...
def process_grid(path, xi, yi, row_id, eva=True):
    ...
    # print(len(preds), len(row_id))
    preds['row_id'] = row_id
    return score, preds


def process_all(path, size, x_step, y_step):
    df_all = []
    score_all = []
    cache_name = '/home/workspace/checkins/data/cache/cache_get_data_split_655200_size_10.00_rmol_1.00_mci_5.pkl'
...
if __name__ == '__main__':
  main(stamp='treva_full10', x_step=0.16, y_step=0.08, do_submit=False, base='treva_all_xstep0.6_elite_20160630_0.57802.csv.gz')
