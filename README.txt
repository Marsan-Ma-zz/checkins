...
[Snippet/Tool]
  1. get_NbyM_grid
    https://www.kaggle.com/howardxie/facebook-v-predicting-check-ins/get-nbym-grid/code
  2. Centroids of places in FB check-in data (should mod by considering "accuracy")
    https://www.kaggle.com/tlehman/facebook-v-predicting-check-ins/centroids-of-places-in-fb-check-in-data/discussion
...
[Train]
  ...
  1. python starter (LB: ~0.55)
    https://www.kaggle.com/valeriur/facebook-v-predicting-check-ins/python-starter-0-55/discussion
  2. mad-script-battle-r-version
    https://www.kaggle.com/apapiu/facebook-v-predicting-check-ins/mad-script-battle-r-version/code
...
[Features] to train the model
  ...
  0. [Time (cat)] timestamp(min) => hour, weekday, month
